...
function preload()
{
  ball_touch_audio = loadSound("ball_touch_paddel.wav");
  ball_missed_audio = loadSound("missed.wav");
}
...
function gotPoses(results)
{
  ...
  {
    console.log(results);
    wristX = results[0].pose.keypoints[10].x;
    wristY = results[0].pose.keypoints[10].y;
    wristscore = results[0].pose.keypoints[10].confidence;
  }
}
